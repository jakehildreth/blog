...
* Kalahari Resort
* Sandusky, OH
* [codemash.org](https://codemash.org)
...
- Co-presenting with [Eric Woodruff](https://ericonidentity.com)
- Talk Tile: Can opposites attract? Domain admins meet red tenant.
- Abstract: 

A defense-focused con with a very different vibe from other conferences I've attended. Very beginner-friendly and a little more "soft skills" focused. I'll be co-presenting with pal [Eric Woodruff](https://ericonidentity.com) about a wild hybrid Microsoft identity idea: using a "red tenant" to administer an on-prem Active Directory.
...
- Charleston Place
- Charleston, SC
- [hipconf.com](https://hipconf.com)

This conference is put on by [my employer](https://semperis.com), but it's not a user conference. This is a space for leaders in the identity space to share modern approachs to defending the enterprise. For example, [my previous boss](https://adsecurity.org) spoke there last year. I was chosen to speak, so I'll be talking about combining Low- and Medium-severity AD CS issues into Critical issues that can result in complete forest compromise.
